...
public class UserTestUtil {
	...
	public static List<UserTest> getUserTests() {
		...
		List<Question> questions = new ArrayList<>();
				...
				e1q1.add(new Answer("Answer 1", true));
				e1q1.add(new Answer("Answer 2", false));
			questions.add(new Question("e1q1", "Question 1", e1q1));
				List<Answer> e1q2 = new ArrayList<>();
				e1q2.add(new Answer("Answer 1", false));
				e1q2.add(new Answer("Answer 2", false));
				e1q2.add(new Answer("Answer 3", true));
			questions.add(new Question("e1q2","Question 2", e1q2));
				List<Answer> e1q3 = new ArrayList<>();
				e1q3.add(new Answer("Answer 1", true));
				e1q3.add(new Answer("Answer 2", false));
				e1q3.add(new Answer("Answer 3", false));
				e1q3.add(new Answer("Answer 4", false));
			questions.add(new Question("e1q3","Question 3", e1q3));

		userTests.add(new UserTest("e1", "Exercise 1", questions));

		List<Question> questions2 = new ArrayList<>();
			List<Answer> e2q1 = new ArrayList<>();
			e2q1.add(new Answer("Answer 1", true));
			e2q1.add(new Answer("Answer 2", false));
		questions2.add(new Question("e2q1", "Question 1", e2q1));
			List<Answer> e2q2 = new ArrayList<>();
			e2q2.add(new Answer("Answer 1", false));
			e2q2.add(new Answer("Answer 2", true));
		questions2.add(new Question("e2q2", "Question 2", e2q2));
